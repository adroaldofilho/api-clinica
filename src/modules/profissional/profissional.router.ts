...
export class ProfissionalRouterModule  extends BaseRouterModule {
    ...
    protected MODULES_ENDPOINT_MAP: ModuleEndpointMap = { 
        [this.moduleName]: {
            get: [
                ...
                {
                    endpoint: `${ this.context }/${ this.version }/${ this.moduleName }/:idProfissional`,
            ...
            delete: [
                {
                    endpoint: `${ this.context }/${ this.version }/${ this.moduleName }/:idProfissional/destroy`,
    ...
    async create(req: Request, res: Response){
        try {
            ...
            return ResponseHandlers.onError(res, 'Erro ao incluir profissional', error);
        }
    }
